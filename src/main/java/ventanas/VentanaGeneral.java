...
public class VentanaGeneral extends JFrame implements ActionListener{
    ...
    protected JLabel generarJLabelEncabezado(JFrame contenedor, String texto, int posicionX, int posicionY, int largoX, int largoY){
    ...
    protected JLabel generarJLabel(JLabel label, String texto, int posicionX, int posicionY, int largoX, int largoY) {
